...
- **Nessuna nuova voce di baseline.** La baseline attuale (`phpstan-baseline.neon`, 6 voci di livello 5) resta invariata. Obiettivo di ogni gradino: zero errori a quel livello senza aggiungere righe alla baseline.
